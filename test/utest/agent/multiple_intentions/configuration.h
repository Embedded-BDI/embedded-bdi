...
public:
  MultipleIntentions()
  {
    ...
    BodyInstruction inst_0_0(BodyType::ACTION, prop_0_body_0, action_1_multiple_intentions);
    ...
    BodyInstruction inst_0_1(BodyType::ACTION, prop_1_body_0, action_2_multiple_intentions);
    ...
    Proposition prop_2_body_0(6);
    BodyInstruction inst_0_2(BodyType::ACTION, prop_2_body_0, action_3_multiple_intentions);
    ...
    Proposition prop_3(7);
    Context * context_3 = new Context(0);
    Body * body_3 = new Body(1);

    Proposition prop_3_body_0(8);
    BodyInstruction inst_0_3(BodyType::ACTION, prop_3_body_0, action_4_multiple_intentions);
    ...
    Proposition prop_4(2);
    Context * context_4 = new Context(0);
    Body * body_4 = new Body(2);

    Proposition prop_4_body_0(9);
    BodyInstruction inst_0_4(BodyType::ACTION, prop_4_body_0, action_5_multiple_intentions);
    ...
    BodyInstruction inst_0_5(BodyType::ACTION, prop_5_body_0, action_6_multiple_intentions);
