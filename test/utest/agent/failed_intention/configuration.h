...
public:
  FailedIntention()
  {
    ...
    BodyInstruction inst_0_0(BodyType::ACTION, prop_0_body_0, action_return_false);
    ...
    BodyInstruction inst_0_1(BodyType::ACTION, prop_1_body_0, action_deletion_1);
    ...
    BodyInstruction inst_0_2(BodyType::ACTION, prop_2_body_0, action_return_true);
    ...
    BodyInstruction inst_2_2(BodyType::ACTION, prop_2_body_2, action_return_true);
    ...
    BodyInstruction inst_0_3(BodyType::ACTION, prop_3_body_0, action_return_true);
    ...
    BodyInstruction inst_0_4(BodyType::ACTION, prop_4_body_0, action_return_false);
    ...
    BodyInstruction inst_0_5(BodyType::ACTION, prop_5_body_0, action_deletion_1);
    ...
    BodyInstruction inst_0_6(BodyType::ACTION, prop_6_body_0, action_deletion_2);
