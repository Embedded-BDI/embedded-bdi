...
public:
  OverflowStackedIntention()
  {
    ...
    BodyInstruction inst_0_0(BodyType::ACTION, prop_0_body_0, action_1_1_overflow_stacked_intention);
    ...
    Proposition prop_0_body_2(1);
    BodyInstruction inst_2_0(BodyType::ACTION, prop_0_body_2, action_1_2_overflow_stacked_intention);
    ...
    BodyInstruction inst_0_1(BodyType::ACTION, prop_1_body_0, action_2_1_overflow_stacked_intention);
    ...
    Proposition prop_1_body_2(3);
    BodyInstruction inst_2_1(BodyType::ACTION, prop_1_body_2, action_2_2_overflow_stacked_intention);
    ...
    BodyInstruction inst_0_2(BodyType::ACTION, prop_2_body_0, action_3_1_overflow_stacked_intention);
    ...
    Proposition prop_2_body_2(5);
    BodyInstruction inst_2_2(BodyType::ACTION, prop_2_body_2, action_3_2_overflow_stacked_intention);
    ...
    BodyInstruction inst_0_3(BodyType::ACTION, prop_3_body_0, action_4_1_overflow_stacked_intention);
    body_3->add_instruction(inst_0_3);

    Proposition prop_3_body_1(8);
    BodyInstruction inst_1_3(BodyType::GOAL, prop_3_body_1, EventOperator::GOAL_ADDITION);
    body_3->add_instruction(inst_1_3);

    Proposition prop_3_body_2(7);
    BodyInstruction inst_2_3(BodyType::ACTION, prop_3_body_2, action_4_2_overflow_stacked_intention);
    ...
    BodyInstruction inst_0_4(BodyType::ACTION, prop_4_body_0, action_5_1_overflow_stacked_intention);
