...
public:
  AgentSettings()
  {
    ...
    Belief belief_belief_1(0, nullptr, true);
    ...
    Statement stm_0(1);
    Context * context_0 = new Context(1);
    Body * body_0 = new Body(2);

    Statement stm_0_belief_1(0);
    ContextCondition cond_0_0(stm_0_belief_1, true);
    ...
    BodyInstruction inst_1_1(BodyType::BELIEF, stm_1_body_1, EventOperator::BELIEF_ADDITION);
    ...
    Body * body_5 = new Body(2);

    Statement stm_5_body_0(12);
    BodyInstruction inst_0_5(BodyType::ACTION, stm_5_body_0, action_action_6);
    body_5->add_instruction(inst_0_5);

    Statement stm_5_body_1(13);
    BodyInstruction inst_1_5(BodyType::GOAL, stm_5_body_1, EventOperator::GOAL_ADDITION);
    ...
    Statement stm_6_body_0(14);
    BodyInstruction inst_0_6(BodyType::GOAL, stm_6_body_0, EventOperator::GOAL_ADDITION);
    ...
    Body * body_7 = new Body(2);

    Statement stm_7_body_0(15);
    BodyInstruction inst_0_7(BodyType::ACTION, stm_7_body_0, action_action_7);
    body_7->add_instruction(inst_0_7);

    Statement stm_7_body_1(4);
    BodyInstruction inst_1_7(BodyType::GOAL, stm_7_body_1, EventOperator::GOAL_ADDITION);
    ...
    Statement stm_8_body_0(16);
    BodyInstruction inst_0_8(BodyType::ACTION, stm_8_body_0, action_action_8);
